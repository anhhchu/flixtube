...
function main() {
 ...
 return mongodb.MongoClient.connect(DBHOST)
  .then (client => {
        ...
        app.listen(PORT, () => {
            console.log("Microservice listening!!! please load file db/videos.json to mongodb before testing")
        });
    });
}
// Call main function
...
main()
    .then(() => console.log("video-streaming microservice online. Check video at http://localhost:4002/video?id=5d9e690ad76fe06a3d7ae416"))
    .catch(err => {
